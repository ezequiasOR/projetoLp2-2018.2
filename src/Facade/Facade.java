...
public class Facade {
	...
	public static void main(String[] args) {
		args = new String[] { "Facade.Facade", "testes/acceptance_tests/use_case_1.txt",
				"testes/acceptance_tests/use_case_2.txt", "testes/acceptance_tests/use_case_3.txt",
				"testes/acceptance_tests/use_case_4.txt", "testes/acceptance_tests/use_case_5.txt",
				"testes/acceptance_tests/use_case_6.txt", "testes/acceptance_tests/use_case_7.txt" };
	...
	/**
	 * @return Retorna representacao textual de todos os descritores cadastrados no
	 *         sistema por ordem de quantidade,
	 */
	...
	/**
	 * @return Retorna representacao textual de todos os itens cadastrados no
	 *         sistema por ordem de quantidade. Caso haja quantidades iguais, o
	 *         sistema ordenara alfabeticamente pelo descritor.
	 */
	 ...
	 * @return Retorna representacao textual de todos os itens cadastrados que
	 *         atendem a descricao.
	 */
	...
	/**
	 * @return Retorna representacao textual de todos os pedidos de itens
	 *         necessarios.
	 */
