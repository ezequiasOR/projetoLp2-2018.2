...
/**
 * Classe auxiliar em que valida parametros de metodos de outras classes e
 * objetos.
 * 
...
public class Validador implements Serializable {
	...
	/**
	 * Valida os parametros de um usuario a ser cadastrado. Um Usuario nao pode ter
	 * nenhum de seus parametros null ou espacos vazios (com espacos tambem).
	 * 
	...
	/**
	 * Valida a classe de um usuario a ser cadastrado. Um usuario so pode ter como
	 * classe: PESSOA_FISICA, IGREJA, ONG, ORGAO PUBLICO MUNICIPAL, ORGAO PUBLICO
	 * ESTADUAL, ORGAO PUBLICO FEDERAL, ASSOCIACAO e SOCIEDADE.
	 * 
	...
	public void validaClasse(String classe) {
		if (!classe.toUpperCase().equals("PESSOA_FISICA") && !classe.toUpperCase().equals("IGREJA")
				&& !classe.toUpperCase().equals("ONG") && !classe.toUpperCase().equals("ORGAO PUBLICO MUNICIPAL")
				&& !classe.toUpperCase().equals("ORGAO PUBLICO ESTADUAL")
				&& !classe.toUpperCase().equals("ORGAO PUBLICO FEDERAL") && !classe.toUpperCase().equals("ASSOCIACAO")
				&& !classe.toUpperCase().equals("SOCIEDADE")) {
	 ...
	 * 
	 * @param nome Nome do usuario a ser validado, o nome nao pode ser null nem
	 *             vazio.
	 */
	 ...
	 * 
	 * @param email Email do usuario a ser validado, o email nao pode ser null nem
	 *              vazio.
	 */
	 ...
	 * 
	 * @param celular Numero celular de um usuario a ser validado, o celular nao
	 *                pode ser null nem vazio.
	 */
	 ...
	 * 
	 * @param quantidade Quantidade de um item separadamente, a quantidade nao pode
	 *                   ser negativa.
	 */
	...
	/**
	 * Valida uma descricao a ser cadastrada, de um descritor ou item(doacao ou
	 * recepcao).
	 * 
	 ...
	 * 
	 * @param id         Id do usuario a ser validado, nao podendo ser null nem
	 *                   vazio.
	 * @param descricao  Descricao do item a ser validada, nao podedo ser null nem
	 *                   vazio.
	 * @param quantidade Quantidade do item a ser validada, nao podendo ser
	 *                   negativa.
	 */
	...
	/**
	 * Valida os parametros de uma pequisa sobre itens com a mesma
	 * descricao(descritores).
	 * 
	 * @param descricao Descricao a ser validada, nao podendo ser null nem vazia.
	 */
